    ...
    <body class="bg-blue-200">
        ...
        <div class="container mx-auto p-8">
            <h1 class="text-3xl font-semibold mb-4">Về chúng tôi</h1>
        
            <p class="mb-4">Chúng tôi là một đội ngũ chăm sóc sức khỏe chuyên nghiệp, cam kết mang lại dịch vụ y tế chất lượng cao cho cộng đồng.</p>
        
            <p class="mb-4">Địa chỉ: 123 Đường ABC, Thành phố XYZ</p>
        
            <p class="mb-4">Liên hệ: contact@vechungtoi.com</p>
        
            <p>Mọi thắc mắc hoặc đóng góp ý kiến, bạn có thể liên hệ trực tiếp với chúng tôi qua địa chỉ email trên.</p>
        </div>
        <div class="h-32 bg-cover bg-center relative mt-[380px]"
