...
<body class="bg-blue-100">
    ...
    <div class="mt-12">
        @foreach ($new as $question)
                        ...
                        <div class="bg-white p-4 shadow-md rounded-md relative w-[50%] ml-[25%]">
                            ...
                            <div class="mt-4 flex space-x-4">
                                <a href="{{ route('servicenewsid', $question['id']) }}" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Chi tiết</a>
