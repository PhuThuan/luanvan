        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <div class="mt-4 mx-4">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <span class="mr-2">Số lượng hồ sơ:</span>
                        <span class="font-bold">{{ count($patients) }}</span>
                    </div>
                    <div>
                        <span class="mr-2">Số hồ sơ đã sử dụng:</span>
                        <span class="font-bold">{{count($uniqueValue)}}</span>
                    </div>
                    <div class="flex items-center">
                        <input type="text" placeholder="Tìm kiếm..." class="border rounded-l px-2 py-1" id="searchInput">

                        
                        <button class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded-r">Tìm kiếm</button>
                    </div>
                ...
                <table class="min-w-full bg-white border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="patient-row">
                            ...
                            <td class="py-2 px-4 border-b">{{$patient['province']}}</td>
                            @if ($patient['status']==0)
                            ...
                            <td class="py-2 px-4 border-b">
                                <button class="bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded-full" onclick="showDetails({{ $id }})">Chi Tiết</button>
                            </td>
                            <!-- Thêm các cột khác tương tự -->
                        </tr>
                        @endforeach
...
<script>
    ...
    function searchPatients() {
        ...
        $('.patient-row').each(function () {
            ...
            $(this).css('display', containsSearchTerm ? 'table-row' : 'none');
        });
    }
</script>
