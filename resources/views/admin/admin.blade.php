    ...
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased text-black ">
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <div class="mt-4 mx-4">
                ...
                <h1 class="text-4xl font-bold mb-6 text-blue-700">Tổng Quan Hệ Thống</h1>

                <div class="grid grid-cols-2 gap-4">
                  

                    <!-- Số Người Truy Cập trong Hôm Nay -->
                    <div class="mb-6">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded-full shadow-lg">
                            Số Người Truy Cập trong Hôm Nay: {{ $users }}
                        </button>
                        <p class="text-sm mt-2 text-gray-600">Đánh giá số lượng người truy cập hệ thống trong ngày hiện
                            tại.</p>
                    </div>

                    <!-- Số Lịch Khám trong Ngày -->
                    <div class="mb-6">
                        <button class="bg-green-500 hover:bg-green-700 text-white py-2 px-4 rounded-full shadow-lg">
                            Số Lịch Khám trong Ngày: {{ $appointmentSchedule }}
                        </button>
                        <p class="text-sm mt-2 text-gray-600">Theo dõi số lượng lịch khám được đặt trong ngày.</p>
                    </div>

                    <!-- Số Phòng Khám trong Hệ Thống -->
                    <div class="mb-6">
                        <button class="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded-full shadow-lg">
                            Số Phòng Khám trong Hệ Thống: {{ $hospital }}
                        </button>
                        <p class="text-sm mt-2 text-gray-600">Thông tin chi tiết về từng phòng khám và trạng thái hiện
                            tại của chúng.</p>
                    </div>

                    <!-- Số Bác Sĩ trong Hệ Thống -->
                    <div class="mb-6">
                        <button class="bg-yellow-500 hover:bg-yellow-700 text-white py-2 px-4 rounded-full shadow-lg">
                            Số Bác Sĩ trong Hệ Thống: {{ $doctor }}
                        </button>
                        <p class="text-sm mt-2 text-gray-600">Thông tin chi tiết về chuyên ngành của từng bác sĩ và số
                            lượng bệnh nhân mà họ đang phục vụ.</p>
                    </div>
