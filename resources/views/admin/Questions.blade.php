                ...
                <div class=" flex">
                            ...
                            <ul class="p-4 space-y-4 relative  ">
                                ...
                                <li>
                                    <button class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600"
                                        id="addCategoryButton">Thêm danh mục câu hỏi</button>
                                    <form action="{{ route('questionCategories') }}" method="POST" id="categoryForm"
                                ...
                                @foreach ($questionCategories as $questionCategory)
                                    <li class="flex items-center justify-between bg-white shadow-md p-4 rounded-lg">
                                        ...
                                        <form action="{{ route('deleteCategory', $questionCategory['id']) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                    ...
                    <div class="w-8/12 h-full ">
                        ...
                        <div id="questionForm"
                            ...
                            <form id="questionForm" action="{{ route('storequestion') }}" method="POST">
                                @csrf
                                <!-- Thêm các trường dữ liệu của biểu mẫu tại đây -->
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Tên câu
                                        hỏi</label>
                                    <input
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="name" name='name' type="text" placeholder="Nhập tên câu hỏi">
                                </div>
                                <div class="mb-4">
                                    <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Câu trả
                                        lời</label>
                                    <input
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        id="answer" name="answer" type="text" placeholder="Nhập câu trả lời">
                                </div>
                                <div class="flex justify-end">
                                    <button type="submit"
                                        class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 mr-2"
                                        id="submitQuestionButton">Thêm</button>
                                    <button type="button"
                                        class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600"
                                        id="cancelQuestionButton">Hủy</button>
                                </div>
                            </form>
                        </div>
                                    ...
                                    @foreach ($questions as $question)
                                        @if ($questionCategorie['id'] == $question['id_questionCategories'])
                                            <div class="relative">
                                                ...
                                                <form class="delete-form absolute top-0 right-0" method="post"
                                                    ...
                                                    <input type="hidden" name="question_id"
                                                        value="{{ $question['id'] }}">
                                                    <button type="submit"
                                                        class="bg-red-500 text-white p-2">Xóa</button>
                                                </form>
                                            </div>
                                        @endif
                                    @endforeach
