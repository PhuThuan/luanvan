        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            <div class="mt-4 mx-4">
                <div class="bg-white p-6 shadow-md rounded-md">
                    <h1 class="text-3xl font-bold mb-4">Tên phòng khám: {{ $hospital['name'] }}</h1>

                    <div class="flex items-center mb-4">
                        <h1 class="text-lg font-semibold mr-2">Logo:</h1>
                        <img src="{{ asset($hospital['logo']) }}" alt="Logo phòng khám" class="w-10 h-10"> <button
                            onclick="toggleInput('logo')"
                            class="ml-4 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4">
                            Thay Đổi Logo
                        </button>
                    </div>

                    <h1 class="text-lg font-semibold mb-4">Giới thiệu:</h1>
                    <p class="text-gray-700 mb-4">{{ $hospital['introduce'] }}</p>
                    <button onclick="toggleInput('introduce')"
                        class=" bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4">
                        Thay Đổi Giới Thiệu
                    </button>

                    <h1 class="text-lg font-semibold mb-4">Địa chỉ:</h1>
                    <p class="text-gray-700 mb-4">{{ $hospital['address'] }}</p>

                    <h1 class="text-lg font-semibold mb-4">Chi phí: {{ $cost['cost'] }}
                        <button onclick="toggleInput('cost')"
                            class="ml-4 bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4">
                            Thay Đổi Giá Khám Bệnh
                        </button>
                    </h1>
