...
<head>
    ...
    <A rel="preconnect" href="https://fonts.bunny.net">
        ...
        <script src="/path-to-fullcalendar/core/main.js"></script>
        <script src="/path-to-fullcalendar/daygrid/main.js"></script>
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
            ...
            <div class="mt-4 mx-4">
                ...
                <div class="flex justify-between mb-4">
                    <a href="{{ route('adminworkSchedule',['id'=>$idRoute - 1]) }}">  <button
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Tuần trước
                    </button></a>
                                        ...
                                        @if ($item['day'] == $dateRange)
                                            <div class="border p-4 mb-4">
                                                <p class="text-lg font-semibold mb-2">
                                                   @if ($item['start_time'] >= '13:00' && $item['start_time'] <= '16:30')
                                                  Buổi chiều
                                                  
                                                 
                                                   @elseif  ($item['start_time'] >= '17:00' && $item['start_time'] <= '23:59')
                                                   Buổi tối
                                                   @else
                                                       Buổi sáng
                                                   @endif
